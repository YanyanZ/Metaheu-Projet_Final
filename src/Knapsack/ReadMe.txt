========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet Knapsack
========================================================================

AppWizard a créé cette application Knapsack pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application Knapsack.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé Knapsack.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
